...
const previousOperandandText = document.querySelector(".previousoperand");
const currentOperandandText = document.querySelector(".currentoperand");
const calculator = new Calculator(
  previousOperandandText,
  currentOperandandText
);
